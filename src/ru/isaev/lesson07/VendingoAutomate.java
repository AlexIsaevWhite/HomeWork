...
import static ru.isaev.lesson07.LogicOfAutomate.*;
...
abstract class LogicOfAutomate {
    private static Scanner input = new Scanner(System.in);
    private static boolean endChoise = false;
    private static MachineMenu[] assortment = MachineMenu.values();
